...
const Global = () => {
  ...
  const serviceCards = [
    { 
      ...
      tagImage: doctor,
      title: "Donate",
      content: "Your generous donation can make a significan impact on the lives of young people in Uganda. Help us continue our mission to provide vital health services and education",
      btnName: "Donate"
    },
    { 
      bgImage: two,
      tagImage: center,
      title: "Volunteer",
      content: "Join us in our efforts by volunteering your time and expertise. Together we can make a Difference",
      btnName: "Volunteer"
    },
    { 
      bgImage: three,
